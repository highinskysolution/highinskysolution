  ...
  return (
    <div className="bg-paper">
      ...
      <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden">
        {/* Subtle Ambient Glow */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen animate-blob"></div>
        <div className="absolute bottom-0 left-[-100px] w-[400px] h-[400px] bg-brand/5 rounded-full blur-[100px] pointer-events-none mix-blend-screen animate-blob" style={{ animationDelay: '2s' }}></div>
